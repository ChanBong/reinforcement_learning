...
All code is written in Python 3 and uses RL environments from [OpenAI Gym](https://gym.openai.com/). Advanced techniques use **[Pytorch](https://pytorch.org/)** for neural network implementations.
...
- [2021 DeepMind x UCL Lecture Series (UCL, 2021)](https://www.youtube.com/playlist?list=PLqYmG7hTraZDVH599EItlEWsUOsJbAodm)
